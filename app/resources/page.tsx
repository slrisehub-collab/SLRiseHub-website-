...
export const metadata: Metadata = {
  title: "Resources & Media | SLRiseHub",
  description:
...
const videos = [
  ...
  },
  {
    ...
    duration: "30 min",
    image:
      "https://images.unsplash.com/photo-1475721027767-pfa536027d49?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
  },
];
      ...
      <div className="bg-brand-royal text-white py-16 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <p className="text-xl text-blue-100 max-w-2xl">
            Explore our curated library of learning materials, workshop
            recordings, and tools to support your growth.
          </p>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <section className="mb-20">
          <div className="flex items-center gap-3 mb-8">
            <Video className="h-6 w-6 text-brand-royal" />
        ...
        <section>
          <div className="flex items-center gap-3 mb-8">
            <Download className="h-6 w-6 text-brand-royal" />
            <h2 className="text-2xl font-heading font-bold text-foreground">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {resources.map((res, idx) => (
              <div
                key={idx}
                className="bg-secondary rounded-xl p-6 border border-border hover:shadow-md transition-shadow"
              >
                <div className="flex justify-between items-start mb-4">
                  <div className="p-3 bg-card rounded-lg shadow-sm">
                    {res.type === "DOCX" ? (
                      ...
                      <FileText className="h-6 w-6 text-brand-royal" />
                    )}
                  </div>
                ...
                <p className="text-sm text-muted-foreground mb-4">
                  {res.category} &bull; {res.size}
                </p>
                <DownloadButton url={res.url} />
              </div>
            ))}
          </div>
        </section>

...
export const programs: Program[] = [
  ...
  },
  {
    ...
    shortDescription:
      "Training the next generation of storytellers and journalists to advocate for truth and social change.",
    color: "bg-indigo-600",
    duration: "8 Weeks",
  ...
  },
  {
    ...
    shortDescription:
      "Building confident leaders capable of articulating their vision and inspiring community action.",
    color: "bg-brand-cyan",
    duration: "6 Weeks",
  ...
  },
  {
    ...
    shortDescription:
      "Supporting young founders with mentorship and resources to turn ideas into sustainable businesses.",
    color: "bg-amber-500",
    duration: "16 Weeks",
    format: "Incubator Style",
    level: "Advanced",
    longDescription:
      "Unemployment is a major challenge, but entrepreneurship offers a path forward. This comprehensive incubator program takes participants from ideation to launch. We cover business model canvas generation, financial literacy, pitching to investors, and product development. Participants get access to mentors and potential seed funding.",
    curriculum: [
  ...
  },
  {
    ...
    shortDescription:
      "Demystifying Artificial Intelligence and future tech to prepare Sierra Leone for the 4th Industrial Revolution.",
    color: "bg-brand-dark",
    duration: "10 Weeks",
    format: "Online & Lab",
    level: "Intermediate",
  ...
  },
  {
    ...
    shortDescription:
      "Grassroots initiatives driving positive social impact and civic engagement across the nation.",
    color: "bg-emerald-600",
    duration: "Ongoing",
    format: "Volunteer Based",
    level: "All Levels",
    longDescription:
      "Change happens at the grassroots level. This program is for those who want to be active changemakers. We organize health awareness campaigns, environmental cleanups, and educational drives in underserved rural areas. It is about putting values into action.",
    curriculum: [
